...
### 1. Corpus Definition
- Use **only** the following exact 5 mutual fund scheme URLs from Groww (HDFC AMC) as the knowledge base:
...
- **Strict Constraint:** Do not use any other URLs, schemes, or additional documents.
